...
const BADGE_IMAGE_URL = 'https://hc-cdn.hel1.your-objectstorage.com/s/v3/739361f1d440b17fc9e2f74e49fc185d86cbec14_badge.png';
...
export default function BadgeGenerator() {
    ...
    const handleGenerateBadge = () => {
        ...
        const badgeCode = `<a href="${targetLink}" target="_blank">
        ...
        <div className={styles.container}>
            <div className={styles.content}>
                ...
                <p className={styles.description}>
                    Generate a Shipwrecked badge for your project! This badge shows that your project is part of 
                    Shipwrecked & will put you in the top of the review queue & gallery.
                </p>
                ...
                <div className={styles.form}>
                    <div className={styles.inputGroup}>
                        ...
                        <p className={styles.hint}>
                            Leave blank to use the default Shipwrecked link, or enter your project URL
                        </p>
                    </div>
