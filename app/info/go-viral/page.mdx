...
_(you can make multiple posts on the same platform & add up the interactions as long as it's in a good faith)_

* Twitter (aka X) / Threads - 1.5K likes OR 200 retweets
* Bluesky - 1.5K likes OR 200 reposts
* Github - 150 stars OR 150 dependents
...
* Google Chrome Web Store / Mozilla Add-ons (Firefox Extensions) - 1,000 users OR 4.0+ rating with 100+ reviews
